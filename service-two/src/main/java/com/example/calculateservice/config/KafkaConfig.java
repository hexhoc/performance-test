...
public class KafkaConfig {
    ...
    /**
     * In order to generate and export traces on the consumer side we need to override the ConcurrentKafkaListenerContainerFactory bean. For the container listener factory, we
     * should obtain the ContainerProperties instance and then invoke the setObservationEnabled method. The same as before we can create a custom implementation of the
     * KafkaTemplateObservationConvention interface to include the additional tags (optionally).
     */
    @Bean
